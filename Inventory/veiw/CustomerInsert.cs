...
{
    internal partial class CustomerInsert : Form
    {
        InventoryDbContext dbContext;
        CustomerController customerController;
        public CustomerInsert(InventoryDbContext dbContext)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                customerController.InsertCustomer(textBox1.Text, textBox2.Text,
                    textBox3.Text, textBox4.Text, textBox5.Text, textBox6.Text);
                MessageBox.Show("Custemer created successfully.");
