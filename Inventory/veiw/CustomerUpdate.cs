...
{
    internal partial class CustomerUpdate : Form
    {
        InventoryDbContext dbContext;
        CustomerController customerController;
        public CustomerUpdate(InventoryDbContext dbContext)
        {
            InitializeComponent();
            this.dbContext = dbContext;
            customerController = new CustomerController(dbContext);
            UpdateComboBox1();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int id = ((Customer)comboBox1.SelectedItem).CustomerID;
                customerController.UpdateCustomer(id, textBox1.Text, textBox2.Text,
        ...
        {
            comboBox1.DataSource = customerController.GetCustomers();
        ...
        private void comboBox1_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            if (comboBox1.SelectedItem != null)
            {
                ...
                textBox2.Text = ((Customer)comboBox1.SelectedItem).phone;
                textBox3.Text = ((Customer)comboBox1.SelectedItem).fax;
                textBox4.Text = ((Customer)comboBox1.SelectedItem).mobile;
                textBox5.Text = ((Customer)comboBox1.SelectedItem).email;
                textBox6.Text = ((Customer)comboBox1.SelectedItem).website;
            }
        }
    }
}
