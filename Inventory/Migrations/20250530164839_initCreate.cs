        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_transfer_Item_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "UnitId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_transfer_Item_Warehouses_FromWarehouseWarehouseID",
                        column: x => x.FromWarehouseWarehouseID,
                        principalTable: "Warehouses",
                        principalColumn: "WarehouseID");
                    table.ForeignKey(
                        name: "FK_transfer_Item_Warehouses_ToWarehouseWarehouseID",
                        column: x => x.ToWarehouseWarehouseID,
                        principalTable: "Warehouses",
                        principalColumn: "WarehouseID");
                    table.ForeignKey(
                        name: "FK_transfer_Item_items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "items",
                        principalColumn: "ItemId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_transfer_Item_suppliers_SupplierID",
                        column: x => x.SupplierID,
                        principalTable: "suppliers",
                        principalColumn: "SupplierID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_transfer_Item_FromWarehouseWarehouseID",
                table: "transfer_Item",
                column: "FromWarehouseWarehouseID");

            migrationBuilder.CreateIndex(
                name: "IX_transfer_Item_ItemId",
                table: "transfer_Item",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_transfer_Item_SupplierID",
                table: "transfer_Item",
                column: "SupplierID");

            migrationBuilder.CreateIndex(
                name: "IX_transfer_Item_ToWarehouseWarehouseID",
                table: "transfer_Item",
                column: "ToWarehouseWarehouseID");

            migrationBuilder.CreateIndex(
                name: "IX_transfer_Item_UnitId",
                table: "transfer_Item",
                column: "UnitId");
